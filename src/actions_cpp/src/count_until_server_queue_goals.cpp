...
{
public:
    CountUntilServerQueueGoalsNode() : Node("count_until_server_queue_goals") 
    {
        goal_queue_thread_ = std::thread(&CountUntilServerQueueGoalsNode::run_goal_queue_thread, this);
        cb_group_ = this->create_callback_group(rclcpp::CallbackGroupType::Reentrant);
         count_until_server_ = rclcpp_action::create_server<CountUntil>(
            this,
            "count_until",
            std::bind(&CountUntilServerQueueGoalsNode::goal_callback, this, _1, _2),
            std::bind(&CountUntilServerQueueGoalsNode::cancel_callback, this, _1),
            std::bind(&CountUntilServerQueueGoalsNode::handle_accepted_callback, this, _1),
    ...
    {
        goal_queue_thread_.join(); // Prevent memory leak
    }
...
private:
        ...
        const rclcpp_action::GoalUUID &uuid, std::shared_ptr<const CountUntil::Goal> goal)
    {
        ...
        RCLCPP_INFO(this->get_logger(), "Accepting (and executing) the goal");
