...
public:
  ...
  {}
  ::my_robot_interfaces::msg::LedStatus led_status(::my_robot_interfaces::msg::LedStatus::_led_status_type arg)
  {
...
{
  return my_robot_interfaces::msg::builder::Init_LedStatus_led_status();
}
